            ...
            if (!hasErrors) {
                ...
                if (submitButton) {
                    ...
                    setTimeout(() => {
                        ...
                        successMessage.style.cssText = 'color: #28a745; padding: 1rem; text-align: center; font-weight: 500;';
                        contactForm.reset();
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '793e6bd5-5d13-463d-a21a-6e765eb37102',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '793e6bd5-5d13-463d-a21a-6e765eb37102';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '793e6bd5-5d13-463d-a21a-6e765eb37102';
